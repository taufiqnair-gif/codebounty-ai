...
export default function OwnerAuditDetailsPage() {
  ...
  const { score, vulnerabilities, codeSnippet, recommendations, executionTime } = auditResult
          ...
          <Card className="border-gray-800/50 bg-gray-900/20">
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div>
                  <div className="text-2xl font-bold text-white">{executionTime}</div>
                  <div className="text-sm text-gray-400">Execution Time</div>
                </div>
              </div>
              <div className="flex gap-2 mt-4">
                <Button variant="outline" size="sm" className="btn-cyber-secondary bg-transparent">
